...
function GpsLayer:showGipWaring(flag)
	-- body
	local FileName1 = self.res_base .. '/room/resource/gps/btn_gps_normal.png'
	local FileName2 = self.res_base .. '/room/resource/gps/btn_gps_select.png'
...
function GpsLayer:showSeat(flag , index)
	-- body
	local FileName1 = self.res_base .. '/room/resource/gps/icon_gps_light.png'
	local FileName2 = self.res_base .. '/room/resource/gps/icon_gps_gray.png'
